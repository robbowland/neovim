...
expect_highlight("@punctuation.delimiter", { fg = "#616161" })
...
expect_highlight("MicrographicsDiffviewFold", { fg = "#999999", bg = "#1c1c1c", bold = true })
expect_highlight("MicrographicsDiffviewFoldColumn", { fg = "#999999", bg = "#1c1c1c", bold = true })
...
expect_highlight("MicrographicsDiffviewSource", {}, { "fg", "bg", "bold" })
expect_highlight("MicrographicsDiffviewFold", { fg = "#666666", bg = "#eeeeee", bold = true })
expect_highlight("MicrographicsDiffviewFoldColumn", { fg = "#666666", bg = "#eeeeee", bold = true })
