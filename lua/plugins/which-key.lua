return {
  ...
  opts = function(_, opts)
    ...
    vim.list_extend(opts.spec, {
      {
        mode = { "n", "v" },
        { "<leader>f", group = "Files", icon = icon("files") },
        { "<leader>s", group = "Search", icon = icon("search") },
        { "<leader>g", group = "Git", icon = icon("git") },
        { "<leader>c", group = "Code & LSP", icon = icon("code") },
        { "<leader>d", group = "Debug", icon = icon("debug") },
        { "<leader>t", group = "Tests", icon = icon("tests") },
        { "<leader>u", group = "Toggles", icon = icon("toggles") },
        { "<leader>w", group = "Windows", icon = icon("windows") },
        { "<leader>b", group = "Buffers", icon = icon("buffers") },
        { "<leader>q", group = "Session", icon = icon("session") },
        { "<leader>x", group = "Diagnostics", icon = icon("diagnostics") },
        { "<leader><tab>", group = "Workspace", icon = icon("workspace") },
        { "<leader>dp", group = "Profiler", icon = icon("profiler") },
        { "g", group = "goto", icon = icon("goto") },
      },
